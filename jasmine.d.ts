...
declare module jasmine {
    ...
    interface ObjectContaining {
        ...
        jasmineMatches(other: any, mismatchKeys: any[], mismatchValues: any[]): void;
        jasmineToString(): string;
    }
    ...
    interface Env {
        ...
        compareRegExps_(a: RegExp, b: RegExp, mismatchKeys: string[], mismatchValues: string[]): void;
        compareObjects_(a: any, b: any, mismatchKeys: string[], mismatchValues: string[]): void;
        equals_(a: any, b: any, mismatchKeys: string[], mismatchValues: string[]): void;
        contains_(haystack: any, needle: any): void;
        addEqualityTester(equalityTester: (a: any, b: any, env: Env, mismatchKeys: string[], mismatchValues: string[]) => boolean): void;
        specFilter(spec: Spec): void;
    }
